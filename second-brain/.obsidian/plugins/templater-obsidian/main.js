      ...
      if (e.hasOwnProperty(t))
        if (n.hasOwnProperty(t)) {
          ...
          if (Array.isArray(r) || Array.isArray(i)) {
            ...
            xn(r) && xn(i) ? pr(r, i) : i != null && i !== "" && (n[t] = i);
        } else n[t] = e[t];
  }
}
function yn(n) {
...
function xo(n) {
  ...
  if (d) {
    ...
    if (
      ...
      D = ue;
      var ne =
        _ && F === H && H.visualViewport ? H.visualViewport.height : F[J];
          ...
          if (!w) {
            ...
            if (!!Po($, K)) {
              ...
              for (var D = 0; D < m.orderedModifiers.length; D++) {
                ...
                typeof F == "function" &&
                  (m =
                    F({ state: m, options: te, name: ne, instance: b }) || m);
              }
            }
          }
        },
          ...
          new L.Setting(this.containerEl)
            ...
            .addExtraButton((o) => {
              o.setIcon("up-chevron-glyph")
                .setTooltip("Move up")
                .onClick(() => {
                  Nt(this.plugin.settings.enabled_templates_hotkeys, r, r - 1),
                    this.plugin.save_settings(),
                    this.display();
                });
            })
...
> \u2014 ${o}`;
        ...
        return (
          new P("Error generating daily quote"), "Error generating daily quote"
        );
      }
    };
  }
  ...
  gi = class extends De.Modal {
    ...
    onChooseItem(e) {
      ...
      let t = this.items.filter(
        (r) => !this.selectedItems.some((i) => i === r)
      );
    ...
    function ee(s, p) {
      return s == "var"
        ...
        ? c && p == "declare"
          ...
          : f(B("stat"), Fn)
        : s == "switch"
        ? f(B("form"), Et, q("{"), B("}", "switch"), et, Ln, N, N, ye)
        : s == "case"
        ? f(W, q(":"))
        : s == "default"
        ? f(q(":"))
        ...
        let i = {
          ...
          token: function (o, a) {
            ...
            if (l != null) {
              ...
              return (
                (a.inCommand = !0), `line-${Bi} ${Oi} ${ic} ${a.tag_class}`
              );
            }
