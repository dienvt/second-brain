...
[](https://kafka.apache.org/)[https://kafka.apache.org](https://kafka.apache.org)
...
- -- very old version /zserver/kafka/kafka_2.11-0.9.0.0/bin/kafka-console-consumer.sh --topic CPS_COMMON_ORDER --from-beginning --bootstrap-server 10.60.45.2:9092,10.60.45.5:9092,10.60.45.6:9092 --new-consumer
