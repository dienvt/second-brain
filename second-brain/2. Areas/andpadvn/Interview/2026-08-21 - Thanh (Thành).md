...
- [ ] Greeting and ask for the introduction. Ice breaking
	...
	- [ ] UIT
	- [ ] KMS - Fullstack
	- [ ] kasikorn: bank làm back-end go là chính
		- [ ] Mysql, mongodb
		- [ ] Dùng docker, GCP cloud,
	- [ ] Juker
		- [ ] Consultant là chính
		- [ ] Java và Go 
		- [ ] Dự án của nhà nước, monitor số điện nước, năng lượng mặt trời
			- [ ] Microsoft azure. Storage, docker, kuberneties.
		- [ ] Giải pháp máy móc:
			- [ ] Data enginee: Build data pipline.
			- [ ] aws synamodb.
		- [ ] PySpark.
	...
	- [ ] Kafka:
		...
		- [ ] Consumer groups.
		- [ ] Message queue khác support deadletter queue.
		- [ ] Topic và Partitions: một topic sẽ có bao nhiêu partitions? Durable hay không? 3 cái là broker
	- [ ] Dự án điện, Solar system gửi nhiều data, data đưa về nhiều thì sao
	- [ ] Lượng data lớn: 
		- [ ] Sending realtime
		- [ ] Data như thế nào, UUID, deviceID
		- [ ] Ideal, từ nguồn Producer.
