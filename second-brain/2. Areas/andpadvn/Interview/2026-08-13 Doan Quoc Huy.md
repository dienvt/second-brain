...
- [ ] Greeting and ask for the introduction. Ice breaking
	...
	- [ ] Introduce interviewee (english is optional)
		- [ ] Để bắt đầu thì mời anh giới thiệu bản thân và khinh nghiệp làm việc ha.
- [ ] Hỏi về định hướng khi chọn andpad
	- [ ] Cryto
	- [ ] Match voi he thong cua minh
		- [ ] Risk vê cryto
		- [ ] Có công việc
		- [ ] Nhận lương ko qua crypto
		- [ ] đổi domain
		- [ ] User deposite
	- [ ] Crypto
	- [ ] Deposite create transaction
	- [ ] Duplicate message:
		- [ ] Transaction ID verify
		- [ ] Topup 2 lần
	- [ ] Database: Update tạo transaction
- [ ] Đánh giá về define database
- [ ] 2-30 bảng
	- [ ] Index khoá chính
	- [ ] index Hash
	- [ ] Truy
...
- Send mail: 
- Canh ví block chain:
- Ví lưu ví trong database deposite.
- RPC ethen.
- Auto retry.
- MLM: Deposite.
- Start một cái goroutine.
- Thêm Defer, recovery.  fail hoặc draft. 
- 
- 
