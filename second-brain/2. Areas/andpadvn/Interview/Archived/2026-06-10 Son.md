...
- [ ] Hỏi về định hướng khi chọn andpad
	...
	- [ ] engineering manager. 
		- [ ] IC.
		- [ ] Manager.
	- [ ] Lead team 8-10. cross function team.
	- [ ] Backend 1.2 - 1.5 
	- [ ] Classic -> Plus bank moi
- [ ]  Hỏi về kinh nghiệm làm việc (15’)
	- [ ] Daily tasks
	- [ ] Khó khăn vào thách thức
	- [ ] Backend golang, backend build voi nodejs. 
	- [ ] Bend nhan tin tra loi call voi user. AMW connect voi tiwilio.
	- [ ] Cool .
	- [ ] Build va ship feature la chinh nen la lam full 
	- [ ] 60% FE chi 40%. 50 worker 1000 call toi thi lam sao manage
	- [ ] 2020 toi gio.
	- [ ] 
	- [ ] Platform nen la luu toan bo chi vao mot database. luu trong vong 7 nam
	- [ ] Customer
	- [ ] Sang lam viec voi 
	- [ ] Core banking, 
	- [ ] DB: ADI, third party. customer data. BigQuery .
	- [ ] Khong scale
		- [ ] Call point http
		- [ ] pub/sub.
		- [ ] Twiliio events dunng tu 2018
			- [ ] Edge case
		- [ ] 
		- [ ] API. 
		- [ ] Rest API / GRPC.
		- [ ] Flow automate.
		- [ ] Spinner qua big querry
		- [ ] 2024 : 
			- [ ] Auto resolves.
			- [ ] cost: nguoi xu ly
			...
			- [ ] Claude code.
		- [ ] claude context.
			- [ ] architcu, styple code, centrallize codeing standard
			- [ ] Monore: coding style cua go. security.
			- [ ] Repo markdown. Back-stage 
			- [ ] Dung ca cho BA, tao task tao usage.
			- [ ] Skill write US, analysis.
		- [ ] Code review
			- [ ] Skill code review: tick ho voi CI
			- [ ] Jira ticket trong db. caller nhu nhau
			- [ ] Call mcp de verify
			- [ ] 
	- [ ] Monitoring
