- [ ] 1st technical interview (60m).
    - [ ] Greeting and ask for the introduction.
		...
		- [ ] 40K 
		- [ ] Bidding
			- [ ] External thì dùng http.
			- [ ] sẽ nhận socket từ bên khác.
			- [ ] https/http2
			- [ ] 
    ...
    - [ ]  Hỏi về kinh nghiệm làm việc (15’)
        ...
        - [ ] 40K ~ 100ms P99?
	        - [ ] Không có database
	        - [ ] Load tất cả lên memory
	        - [ ] maping 
		        - [ ] Dùng bitwise dựa trên tags
		        - [ ] request with 7000 campaign
	        - [ ] Caching
		        - [ ] orment: Gọi API bên thứ 3?
			- [ ] Weather: gọi lấy liên tục
				- [ ] sẽ trigger và bỏ qua một số request
				- [ ] redis set?
				- [ ] Background service chưa gặp tình trạng head blocking.
				- [ ] Sorted list: timestamp 
				- [ ] 
        - [ ] AdTech: gửi request tới seller, 
	        - [ ] Add tech là seller, sẽ hứng request và response trong vòng 100ms
	        - [ ] 
        - [ ] 
