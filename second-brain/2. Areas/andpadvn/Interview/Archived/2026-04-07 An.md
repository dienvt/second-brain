- [ ] 1st technical interview (60m).
    - [ ] Greeting and ask for the introduction.
	    ...
	    - [ ] Backend 4 nam lam Go
	    - [ ] lam ve health care, go, posgres
	    - [ ] 
    - [ ] Hỏi về định hướng khi chọn andpad
	    - [ ] Technical nhieu hon
		    - [ ] Thich viet code, xu ly van de
		    - [ ] Lam ve backend
		    - [ ] Co team devops
		    - [ ] Chu yeu lam ve backend
		- [ ] 
    - [ ]  Hỏi về kinh nghiệm làm việc (15’)
		...
		- [ ] Lam frameword
			- [ ] Distributed tracing
		- [ ] Co mind set ve viet sdk handle observation ok
		- [ ] Hello bacsi
			- [ ] viet post
			- [ ] ai chat bot
			- [ ] co forum
			- [ ] health tool , medicine reminder
			- [ ] App va Web co backend 
				- [ ] App va Web doc chung bai viet
				- [ ] App co AI: chi o vn
				- [ ] Web quang cao : asian
			- [ ] Team lam theo microservice
			- [ ] Cac service giao tiep ntn:
				- [ ] PHP 
				- [ ] CDC sync data sang DB internal
				- [ ] Team notify va team data:
			- [ ] Co team SSO xu ly 
				- [ ] Free 
				- [ ] Nguoi dung bit dung feature
				- [ ] BS chi tra loi cau hoi cua user.
			- [ ] Bs tra loi Business ben Web
			- [ ] Nhac uong thuoc
				- [ ] Dung teamoral de setup workflow
					- [ ] Team em dang co bao nhieu user?
				- [ ]  Temporal:
					- [ ] Idempotant
					- [ ] 
				- [ ] Mỗi user sẽ có một list
				- [ ] 
			- [ ] Team size 8 nguoi
				- [ ] Mobile an design
				- [ ] 
			- [ ] lam viec truc tiep voi PM va PO 
