    ...
    - [ ] Greeting and ask for the introduction.
	    ...
	    - [ ] Xử lý data lớn
		    - [ ] Anz Bank:
			    - [ ] Clound, 
			    - [ ] Process development
		    - [ ] Game: login 10 triệu user.
			    - [ ] Context:
				    - [ ] Dùng VJ. migrate từ zing play 
				    - [ ] SDK để đăng nhập
				    - [ ] Migrate online and off line
				- [ ] Hệ thống cũ sẽ dual write
					- [ ] Handle error như thế nào
				- [ ] Khi capture thì xử lý data cũ như thế nào
					- [ ] queue để gửi data và validation.
				- [ ] Dùng hệ thống cũ để sửa lại thông tin.
				- [ ] Hệ thống mới hỗ trợ đăng nhập bằng other third party.
				- [ ] 
		    - [ ] ZLP: Release work flow cho người dùng 100tr
				- [ ] Event user
					- [ ] Delay
			    - [ ] Cashback 
			    - [ ] Onboard
