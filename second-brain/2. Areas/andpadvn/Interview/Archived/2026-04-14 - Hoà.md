- [ ] 1st technical interview (60m).
    ...
    - [ ] Hỏi về định hướng khi chọn andpad
	    - [ ] Expectation
	    - [ ] Làm việc về Golang
	    - [ ] Được học nhiều về linux
    - [ ]  Hỏi về kinh nghiệm làm việc (15’)
	    - [ ] Daily tasks
        - [ ] Khó khăn vào thách thức
        - [ ] 3 năm kinh nghiệm
        - [ ] Sieu việt :
	        - [ ] Job: Search và recommend.
	        - [ ] ORK 
	        - [ ] Maintain job search
	        - [ ] MVP version
	        - [ ] Peer review
	        - [ ] PR merge và 
	        - [ ] Biết về docker mà làm về docker
	        - [ ] Không define: ci không giới thiệu nhiều
		        - [ ] Component
			- [ ] Core product la search 
			- [ ] 
		- [ ] Search việc làm
			- [ ] Fulltext search
			- [ ] Dùng Bleve để search Bleve golang để search. Ranking.
			- [ ] Trade off Job post 20K:
				- [ ] Trade off load memory.
				- [ ] Giảm latency.
				- [ ] 
			- [ ] Recommand job.
			- [ ] Workflow API recommendation. 
			- [ ] User A, Job chạy background chạy background rồi save trong database.
			- [ ] Tới lúc gửi thì load database rồi add vào rabbitMQ.
			- [ ] 11h 
			- [ ] 
			- [ ] 
