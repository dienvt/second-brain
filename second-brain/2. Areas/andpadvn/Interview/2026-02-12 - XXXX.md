...
- [ ] Greeting and ask for the introduction.
	...
	- [ ] Thông
		...
		- [ ] zero trust
		- [ ] Produce tech lead.
			- [ ] Propose solution, review code.
			- [ ] Giai quyết 
			- [ ] Sa sẽ chuẩn
- [ ] Hỏi về định hướng khi chọn andpad
	- [ ] Tại sao lại chọn andpad
	- [ ] Có kết nối trên linkedin.
	- [ ] Định hướng nâng cao kĩ thuật.
		- [ ] Devops. backend
...
- [ ] Verifify wide then narrow the scope
	- [ ] Định hướng app là maintain
		- [ ] Triển khai cho khách hàng mới và fix bug
		- [ ] Kiểm tra ticket từ khách hàng và triểu khai tính năng mới
		- [ ] Zero trust: VPN
			- [ ] Làm app chạy trên.
			- [ ] Backend.
			- [ ] MongoDB? 
	...
	- [ ] How do you observer or telemety your services? Do you apply tracing
		- [ ] Don't have 
		- [ ] Telegraph: Url 10s Image 
		- [ ] Dùng elastic search 
		- [ ] Tracing, jaeger.
		- [ ] Open service middleware. Jeager 
...
- [ ] Golang
	- [ ] What is goroutines
		...
		- [ ] Concurrency
			- [ ] Worker pools
			- [ ] Làm sao để kiểm soát được số lượng pools
