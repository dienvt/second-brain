- [ ] 1st technical interview (60m).
    - [ ] Greeting and ask for the introduction.
	    ...
	    - [ ] Lam PaymentWall:
		    - [ ] Outsource cho cty cua my
		    - [ ] 
    - [ ] Hỏi về định hướng khi chọn andpad
	    - [ ] Cat giam nhan su o VN
	    - [ ] 
    - [ ]  Hỏi về kinh nghiệm làm việc (15’)
        ...
        - [ ] Backend / tich hop.
	        - [ ] Chu yeu lam go
	        - [ ] Cong trung gian, tich hop lien tuc
	        - [ ] Kinh doanh chuyen giao tai lieu tich hop va credential
	        - [ ] phan tich do phuc tap, techlead doc tai lieu. chuyen giao
	        - [ ] Bat dau tich hop
		        - [ ] Them tf moi vao db
		        - [ ] backend se lam 
		        - [ ] Them phan tich hop do
		        - [ ] Thong ke vao bao cao.
		        - [ ] dong goi cho tung bf mot.
		    - [ ] Tat ca la mono
		    - [ ] Sau do tach ra micro
		    - [ ] Service moi se ti
		    - [ ] Tich hop truc tiep voi the
		    - [ ] Card networks. Socket.
		    - [ ] Giu socket luon . 
		    - [ ] Mo socket vinh vien.
		    - [ ] Check status cua service.
		    - [ ] 
		    - [ ] 
		    - [ ] 
		    - [ ] Heart beat/ giao dich / order 
		    - [ ] 
        - [ ] Moi truong International.
        - [ ] SA
        - [ ] Doi dev 15 nguoi
	        - [ ] DevOps
	        - [ ] Doi FE, doi BE
	        - [ ] Co website va call sdk goi web view.
	        - [ ] 
